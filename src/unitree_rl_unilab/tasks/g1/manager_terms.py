"""Unitree-owned Manager-Based terms for G1 biped locomotion.
...
from unitree_rl_unilab.assets import prepare_task_config
...
def make_unitree_g1_walk_env(
    cfg: ManagerBasedRlEnvCfg,
    num_envs: int = 1,
    backend_type: str = "mujoco",
) -> G1WalkManagerBasedEnv:
    """Resolve downstream assets before constructing the G1 owner runtime."""
    prepare_task_config(cfg)
    return make_g1_walk_env(cfg, num_envs=num_envs, backend_type=backend_type)
