...
registry.register_env_config("UnitreeGo2FootStand", ManagerBasedRlEnvCfg)
registry.register_env("UnitreeGo2FootStand", make_unitree_manager_env, sim_backend="mujoco")
registry.register_env("UnitreeGo2FootStand", make_unitree_manager_env, sim_backend="motrix")
registry.register_env("UnitreeGo2FootStand", make_unitree_manager_env, sim_backend="drake")

registry.register_env_config("UnitreeGo2JoystickRough", ManagerBasedRlEnvCfg)
registry.register_env("UnitreeGo2JoystickRough", make_unitree_manager_env, sim_backend="mujoco")
registry.register_env("UnitreeGo2JoystickRough", make_unitree_manager_env, sim_backend="motrix")
